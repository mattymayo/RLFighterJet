...
def make_env(value):
    ...
    """
    def _init():
        env = FlightGearEnv(5000 + 500*value, value)
        #env.port(5000 + value)
        return env
    return _init
...
model = PPO2(CustomLSTMPolicy, env, verbose=1, tensorboard_log="tensorboard/ppo2_flightgear_tensorboard_mango_flyer2/")

# Use bash command tensorboard --logdir ./ppo2_flightgear_tensorboard_mango_flyer2/
...
while i < num_save_points:
    ...
    model.save("models/FlightGearActor_mango_flyer2")
